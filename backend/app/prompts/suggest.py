...
SUGGEST_SYSTEM = """Bạn là trợ lý phân tích dữ liệu kinh doanh. Dựa trên câu hỏi và câu trả
lời vừa rồi, hãy đề xuất 3 câu hỏi TIẾP THEO ngắn gọn, liên quan, mà người dùng có thể muốn
hỏi tiếp về dữ liệu (doanh thu, sản phẩm, khách hàng, chi nhánh, đơn hàng, tồn kho, nhiệm vụ...).
